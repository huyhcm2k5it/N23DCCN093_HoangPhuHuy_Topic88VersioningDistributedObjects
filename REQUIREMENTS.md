...
- **Size / Kích thước**: 30 parts / 326.5 KB (full_dataset.json)
- **Schema / Lược đồ**:
...
- **Fragmentation Strategy / Chiến lược Phân mảnh**: **Horizontal Fragmentation** (Phân mảnh ngang theo category)
  ...
  |------|----------|-----------|-------|
  | Site-A | Engine (Động cơ) | `category = 'engine'` | 10 |
  | Site-B | Chassis (Khung gầm) | `category = 'chassis'` | 10 |
  | Site-C | Interior (Nội thất) | `category = 'interior'` | 10 |
